...
public class PaintMesh : MonoBehaviour
{
    ...
    public float paintHeight = 0.1f;    // Boyanın yüksekliği (kabarıklık)
    ...
    Mesh GenerateRaisedPaintMesh(Vector3[] positions)
    {
        ...
        for (int i = 0; i < positions.Length; i++)
        {
            ...
            // Üst yüzey noktaları
            Vector3 leftPointTop = positions[i] - right + Vector3.up * paintHeight;
            Vector3 rightPointTop = positions[i] + right + Vector3.up * paintHeight;
